...
do **not** join it to LTH thickets A/C/D until SNP matching confirms which
Cunning genet, if any, each LTH thicket matches.
...
experiment. The LTH thicket labels (A, C, D) are **field labels** and are not
